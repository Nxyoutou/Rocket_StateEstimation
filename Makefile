##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.5.0-RC5] date: [Tue Mar 25 08:20:08 EDT 2025] 
##########################################################################################################################
...
Core/Src/RingBuf.c \
Core/Src/bmp_280.c \
Core/Src/icm_20649.c \
Core/Src/StateMachine.c \
Core/Src/AttitudeEstimation.c \
Core/Src/fatfs_sd.c \
Core/Src/FEKF.c \
Core/Src/GEKF.c \
Core/Src/States.c \
...
#######################################
load:
	openocd -d2 -f /usr/share/openocd/scripts/interface/stlink.cfg -f /usr/share/openocd/scripts/target/stm32h7x.cfg -c "program build/USLI_H723.elf verify reset exit"
